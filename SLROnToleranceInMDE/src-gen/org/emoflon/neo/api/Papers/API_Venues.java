...
public class API_Venues {
	...
	public API_Venues(NeoCoreBuilder builder, String platformResourceURIRoot, String platformPluginURIRoot){
		spec = (EMSL_Spec) EMSLUtil.loadSpecification("platform:/resource/SLROnToleranceInMDE/src/Papers/Venues.msl", platformResourceURIRoot, platformPluginURIRoot);
		this.builder = builder;
	}

	//:~> platform:/resource/SLROnToleranceInMDE/src/Papers/Venues.msl#//@entities.0
